...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
                <div class="padre">
        <h2>Lista de tareas ejecutadas dentro del mes seleccionado</h2>
            <br />
    </div>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" AllowPaging="false" DataKeyNames="idEjecu" CssClass="table table-striped table-bordered table-hover">
            <Columns>
                <asp:TemplateField HeaderText="Codigo">
                    ...
                    <ItemTemplate>
                        <asp:Label ID="Label50" runat="server" Text='<%# Bind("notficacion") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
